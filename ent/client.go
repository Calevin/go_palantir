...
// QueryTokens queries the tokens edge of a File.
func (c *FileClient) QueryTokens(f *File) *TokenQuery {
...
// QueryFile queries the file edge of a Token.
func (c *TokenClient) QueryFile(t *Token) *FileQuery {
